...
complete -c csview -s s -l style -d 'Specify the border style' -r -f -a "none\t''
ascii\t''
ascii2\t''
sharp\t''
rounded\t''
...
complete -c csview -l header-align -d 'Specify the alignment of the table header' -r -f -a "left\t''
center\t''
right\t''"
complete -c csview -l body-align -d 'Specify the alignment of the table body' -r -f -a "left\t''
center\t''
right\t''"
